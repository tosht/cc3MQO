...
@implementation cc3MQOSampleWorld
...
//	[self addContentFromPODResourceFile: @"hello-world.pod"];
    ...
    [self addContentFromMQOResourceFile:@"sample_logo.mqo" withName:@"Logo"];
	...
	CC3MeshNode* helloTxt = (CC3MeshNode*)[self getNodeNamed: @"Logo"];
