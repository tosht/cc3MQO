...
#import "cc3MQOSampleAppDelegate.h"
#import "cc3MQOSampleLayer.h"
#import "cc3MQOSampleWorld.h"
#import "CC3EAGLView.h"

@implementation cc3MQOSampleAppDelegate
...
//		CCLOG(@"Retina Display Not supported");
	...
	CC3Layer* cc3Layer = [cc3MQOSampleLayer node];
	[cc3Layer scheduleUpdate];
	
	// Create the customized 3D world, attach it to the layer, and start it playing.
	cc3Layer.cc3World = [cc3MQOSampleWorld world];
